...
A yanked release is hidden from `pip install verity` but still accessible via `pip install verity==0.2.0 --no-index` by users who pin it. It is not deleted.
